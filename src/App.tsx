  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between text-sm sm:text-base">
        ...
        <span className="font-vt text-xl sm:text-2xl" style={{ color }}>
          {value}%
        </span>
      </div>
      ...
      <p className="text-xs sm:text-sm md:text-base text-slate-400 leading-snug">
        {description}
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 bg-slate-900/95 backdrop-blur-md border-b border-white/10 px-4 py-3 flex items-center justify-between z-10">
        <h2 className="text-sm sm:text-base text-slate-300 uppercase tracking-wider font-medium">
          Карточка агента
        </h2>
        <button
          onClick={onClose}
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-xl sm:text-2xl text-white leading-tight font-bold truncate">
              {agent.name}
            </h3>
            <div className="flex items-center gap-2 mt-1.5">
              <span className={`w-3 h-3 rounded-full ${statusCfg.dot}`} />
              <span className="text-sm sm:text-base font-medium" style={{ color: statusCfg.color }}>
                {statusCfg.label}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="p-3 bg-black/20 rounded-lg border border-white/5 text-center">
            ...
            <div className="text-xl sm:text-2xl md:text-3xl font-vt text-white">{agent.deals}</div>
            <div className="text-[10px] sm:text-xs md:text-sm text-slate-400 uppercase tracking-wide mt-0.5">
              Сделки
            </div>
          </div>
          <div className="p-3 bg-black/20 rounded-lg border border-white/5 text-center">
            <TrendingUp size={18} className="mx-auto text-emerald-400 mb-1.5" />
            <div className="text-xl sm:text-2xl md:text-3xl font-vt text-white">{agent.conversion}%</div>
            <div className="text-[10px] sm:text-xs md:text-sm text-slate-400 uppercase tracking-wide mt-0.5">
              Конверсия
            </div>
          </div>
          <div className="p-3 bg-black/20 rounded-lg border border-white/5 text-center">
            ...
            <div
              className={`text-xl sm:text-2xl md:text-3xl font-vt ${
        ...
        <div className="p-3.5 bg-purple-950/30 rounded-lg border border-purple-500/20 space-y-2.5">
          <h4 className="text-sm sm:text-base text-purple-300 uppercase tracking-wide flex items-center gap-2 font-medium">
            <Sparkles size={18} />
            Маппинг метрик
          </h4>
          <div className="space-y-2 text-xs sm:text-sm md:text-base text-slate-200 leading-snug">
        ...
        <div className="space-y-2.5">
          <h4 className="text-sm sm:text-base text-slate-300 uppercase tracking-wide flex items-center gap-2 font-medium">
            <Calendar size={18} />
            Календарь
          </h4>
          <div className="space-y-2">
            {agent.calendar.map((evt, i) => (
              ...
              >
                <span className="font-vt text-lg sm:text-xl text-purple-300 leading-none mt-1 whitespace-nowrap">
                  {evt.time}
                </span>
                <span className="text-xs sm:text-sm md:text-base text-slate-200 leading-snug">
                  {evt.title}
                </span>
              </div>
            ))}
    ...
    <div className="flex gap-1 sm:gap-2 flex-wrap">
      {buttons.map((btn) => (
        <button
          ...
          className={`px-2 py-1.5 sm:px-3 sm:py-2 rounded-lg text-xs sm:text-sm md:text-base border flex items-center gap-1 sm:gap-1.5 transition active:scale-95 ${
            filter === btn.mode
        ...
        >
          ...
          <span className="px-1.5 py-0.5 bg-black/30 rounded text-[10px] sm:text-xs font-medium">
            {btn.count}
          </span>
        </button>
      ))}
      ...
      <header className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-2.5 bg-slate-900/95 border-b border-purple-500/30 z-50 gap-2">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-sm sm:text-base md:text-lg text-white leading-none truncate font-vt">
              Этажи — Дашборд
            </h1>
